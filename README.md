...
| [@lg-chat/suggestion-card](./chat/suggestion-card)                   | [![version](https://img.shields.io/npm/v/@lg-chat/suggestion-card)](https://www.npmjs.com/package/@lg-chat/suggestion-card)                     | ![downloads](https://img.shields.io/npm/dm/@lg-chat/suggestion-card?color=white)           | [Live Example](http://mongodb.design/component/suggestion-card/live-example)          |

...
| [@lg-chat/chat-side-nav](./chat/chat-side-nav)                       | [![version](https://img.shields.io/npm/v/@lg-chat/chat-side-nav)](https://www.npmjs.com/package/@lg-chat/chat-side-nav)                         | ![downloads](https://img.shields.io/npm/dm/@lg-chat/chat-side-nav?color=white)             | [Live Example](http://mongodb.design/component/chat-side-nav/live-example)            |

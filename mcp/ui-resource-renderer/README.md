...
Renders an MCP UI resource within an iframe. The component automatically configures the iframe to resize based on content and passes dark mode preferences to the embedded UI.

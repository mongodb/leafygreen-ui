...
module.exports = {
  ...
  moduleNameMapper: {
    '.(png|jpg|jpeg|gif|woff|woff2|ttf|less|eot)$':
      '@lg-tools/jest/mocks/fileMock.js',
  },
  ...
  transform: {
    '^.+\\.[jt]sx?$': 'babel-jest',
    '.svg': '@lg-tools/jest/mocks/svgTransformer.js',
  },
  ...
  setupFiles: ['@lg-tools/jest/jest.setup.js', 'jest-canvas-mock'],

  setupFilesAfterEnv: [
    '@testing-library/jest-dom/extend-expect',
    '@lg-tools/jest/jest.common.setup.ts',
  ],
};

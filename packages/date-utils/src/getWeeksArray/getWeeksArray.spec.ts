...
describe('packages/date-utils/getWeeksArray', () => {
  test('starts the week on the correct day for the locale', () => {
    ...
    const arr = getWeeksArray(month, { locale: SupportedLocales.en_US });
  ...
  describe('August 2023', () => {
    ...
    const arr = getWeeksArray(aug23, { locale: SupportedLocales.ISO_8601 });
  ...
  describe('September 2023', () => {
    ...
    const arr = getWeeksArray(sept23, { locale: SupportedLocales.ISO_8601 });
  ...
  describe('February 2023', () => {
    ...
    const arr = getWeeksArray(feb23, { locale: SupportedLocales.ISO_8601 });

...
| placeholder            | string                                    | A placeholder for the input element                                                                                                                                                                                                                                                                                                                                                                                                                                 | 'Select'                 |
...
| state                  | 'error', 'none'                           | The error state of the component                                                                                                                                                                                                                                                                                                                                                                                                                                    | 'none'                   |
...
| filteredOptions        | Array<string>, null                       | An array used to define which options are displayed. Do not remove Options from the JSX children, as this will affect the selection                                                                                                                                                                                                                                                                                                                                 |                          |
...
| chipCharacterLimit     | number                                    | Defined the character limit of a multiselect Chip before they start truncating. The three ellipses dots are included in the character limit.                                                                                                                                                                                                                                                                                                                        | 12                       |

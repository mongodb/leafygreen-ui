...
function RealmLogo({
  ...
  return (
    ...
    >
      ...
      />
      <path
        className={getColor(knockout, size, '#6e60f7', '#6e60f2')}
      ...
      <path
        className={getColor(knockout, size, '#f9d2c3', 'url(#realm-path-0003)')}

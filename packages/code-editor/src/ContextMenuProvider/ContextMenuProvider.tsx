...
import { providerContainerStyles } from './ContextMenuProvider.styles';
import { ContextMenuProviderProps } from './ContextMenuProvider.types';

/**
 * A simple context menu provider that adds custom right-click functionality to all child elements.
 *
...
export const ContextMenuProvider: FC<ContextMenuProviderProps> = ({
  ...
  return (
    <div onContextMenu={handleContextMenu} className={providerContainerStyles}>
      {children}
      <ContextMenu state={menuState} hideMenu={hideMenu} />
    </div>
  );
};

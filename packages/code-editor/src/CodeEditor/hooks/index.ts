...
} from './extensions/useLanguageExtension';
export { useLineNumbersExtension } from './extensions/useLineNumbersExtension';
export { useLineWrapExtension } from './extensions/useLineWrapExtension';
export { usePlaceholderExtension } from './extensions/usePlaceholderExtension';

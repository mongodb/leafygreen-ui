...
| `title` | `string` or `null`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | Renders a title tag with the passed string within the SVG element for screen reader accessibility. Setting this value to `null` will entirely unset the title. <br />By default, a human-readable title will be generated based on the glyph's name. |             |

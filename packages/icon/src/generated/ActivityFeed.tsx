...
* @checksum 2813ec2cf9b665956cefc268db3eefaf
*/
...
const ActivityFeed = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('ActivityFeed');

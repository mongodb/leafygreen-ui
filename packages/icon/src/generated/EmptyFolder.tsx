...
* @checksum 9bd2bb533cddce79a48cfeee0aed97e3
*/
...
const EmptyFolder = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('EmptyFolder');

...
* @checksum 928620cc197c9f3ad251f9a1519d2cb1
*/
...
const HorizontalDrag = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('HorizontalDrag');

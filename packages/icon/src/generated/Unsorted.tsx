...
* @checksum 6c6016fa25834110f8582a1e11a81d5b
*/
...
const Unsorted = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Unsorted');

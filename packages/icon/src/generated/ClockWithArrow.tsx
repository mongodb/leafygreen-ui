...
* @checksum 1f261dbd86e65d09769989cba6382d55
*/
...
const ClockWithArrow = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('ClockWithArrow');

...
* @checksum e0920de0cf5c2026ad8fd4d3451ce698
*/
...
const Escalation = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Escalation');

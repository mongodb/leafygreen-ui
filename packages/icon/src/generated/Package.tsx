...
* @checksum 291c81fcf2c120ec6d97bfdb196d0f2a
*/
...
const Package = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Package');

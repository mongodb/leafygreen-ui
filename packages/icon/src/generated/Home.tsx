...
* @checksum 62df7ce027ed63d443954c889d8d6e8b
*/
...
const Home = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Home');

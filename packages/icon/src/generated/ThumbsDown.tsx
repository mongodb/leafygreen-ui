...
* @checksum 29c4d7dfeab718352966f3a0a257e72f
*/
...
const ThumbsDown = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('ThumbsDown');

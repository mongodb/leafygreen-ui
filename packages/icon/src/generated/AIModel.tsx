...
* @checksum a3748e656ce3fc03dc9c6004b68fe943
*/
...
const AIModel = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('AIModel');

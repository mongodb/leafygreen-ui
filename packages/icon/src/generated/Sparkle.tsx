...
* @checksum f125d391e488e1a62e5d4826078825be
*/
...
const Sparkle = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Sparkle');

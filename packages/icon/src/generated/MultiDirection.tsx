 ...
 * @checksum 4511de1546e33b9aedfc7e71f6ea1886
 */
...
export interface MultiDirectionProps extends LGGlyph.ComponentProps {}
const MultiDirection = ({
  className,
  size = 16,
  title,
  ...
  const noFlexShrink = css`
    flex-shrink: 0;
  `;
  const accessibleProps = generateAccessibleProps(role, 'MultiDirection', {
    title,
    ['aria-label']: ariaLabel,
    ['aria-labelledby']: ariaLabelledby,
  });
...
MultiDirection.displayName = 'MultiDirection';
MultiDirection.isGlyph = true;

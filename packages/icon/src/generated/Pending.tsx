...
* @checksum 6e78ffa3455838941554f2c45393fd67
*/
...
const Pending = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Pending');

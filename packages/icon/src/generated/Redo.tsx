...
* @checksum 4e8057122bb2b5b101b66db215c9bbf5
*/
...
const Redo = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Redo');

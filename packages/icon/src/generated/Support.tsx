...
* @checksum 719f33633518974fa159a17ceb466c37
*/
...
const Support = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Support');

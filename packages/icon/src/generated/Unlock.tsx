...
* @checksum a0ece5ef435641a695fcead57cd64bbf
*/
...
const Unlock = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Unlock');

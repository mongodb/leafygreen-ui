...
* @checksum 49eacbfc9851fa66f0169fd11940713b
*/
...
const TimeSeries = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('TimeSeries');

...
* @checksum df4b2508f88efc6e6875695a7412333d
*/
...
const LogOut = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('LogOut');

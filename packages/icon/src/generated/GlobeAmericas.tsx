...
* @checksum 626ae2f4427b8398e2f13e83ab035c64
*/
...
const GlobeAmericas = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('GlobeAmericas');

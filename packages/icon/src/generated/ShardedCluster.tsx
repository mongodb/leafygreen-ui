...
* @checksum 739b9994ed3728c755ca9dcbad4683b3
*/
...
const ShardedCluster = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('ShardedCluster');

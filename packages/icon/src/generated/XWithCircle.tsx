...
* @checksum 848f1998d777b5aa5b42ab36ff45c8a1
*/
...
const XWithCircle = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('XWithCircle');

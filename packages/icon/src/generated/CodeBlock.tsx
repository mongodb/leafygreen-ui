...
* @checksum 1aaacc8223bc910206709bafaa6349ed
*/
...
const CodeBlock = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('CodeBlock');

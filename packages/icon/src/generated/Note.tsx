...
* @checksum 694a32080e1676dc44eff36fa193f608
*/
...
const Note = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Note');

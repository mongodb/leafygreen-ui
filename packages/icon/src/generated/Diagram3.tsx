...
* @checksum 515d84bc4a530a630a2f0af3660e328b
*/
...
const Diagram3 = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Diagram3');

...
* @checksum 6c378e56f2804858a32a04404df69921
*/
...
const Plus = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Plus');

...
* @checksum ffaea53af0bd50be3d990cfdb2dec02f
*/
...
const Diagram2 = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Diagram2');

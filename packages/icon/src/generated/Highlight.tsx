...
* @checksum a2d8f4fdf836b5cabd9e528c4d3839b4
*/
...
const Highlight = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Highlight');

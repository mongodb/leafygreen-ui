...
* @checksum 2e9284f44ccfbe532036cb60660cec20
*/
...
const Guide = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Guide');

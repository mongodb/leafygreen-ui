...
* @checksum a906ba92a5524b002ec64d0bd603f974
*/
...
const Refresh = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Refresh');

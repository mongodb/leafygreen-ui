...
* @checksum e306f93939dfffb3da0c4089cf01ba9a
*/
...
const String = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('String');

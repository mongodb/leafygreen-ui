...
* @checksum 9415513de01b6bf82b9944227fc216f0
*/
...
const ThumbsUp = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('ThumbsUp');

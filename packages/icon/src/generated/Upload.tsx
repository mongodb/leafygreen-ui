...
* @checksum c5284211edadc2d85b461bcd40cb5539
*/
...
const Upload = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Upload');

...
* @checksum 1aa41229e40d1b226ae54b012d50a604
*/
...
const Read = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Read');

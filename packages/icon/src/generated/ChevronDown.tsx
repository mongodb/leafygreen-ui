...
* @checksum a7e3b1cd2ae0bded693447b271333892
*/
...
const ChevronDown = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('ChevronDown');

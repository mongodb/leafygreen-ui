...
* @checksum cbbbbe6b50aa8fe21a5942abea19d66e
*/
...
const Format = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Format');

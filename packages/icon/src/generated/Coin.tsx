...
* @checksum a1acb911168235fe2cb4c0f86d86657f
*/
...
const Coin = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Coin');

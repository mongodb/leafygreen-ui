...
* @checksum 345c4b3ae3703a11c3a2d87ff86a3212
*/
...
const SortAscending = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('SortAscending');

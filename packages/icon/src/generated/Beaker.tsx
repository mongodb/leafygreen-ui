...
* @checksum a6553a6870c452bfd2fefe354fec7187
*/
...
const Beaker = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Beaker');

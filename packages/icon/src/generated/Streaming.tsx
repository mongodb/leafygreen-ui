...
* @checksum d9e7c5964546b33bc2cf16bd0566be55
*/
...
const Streaming = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Streaming');

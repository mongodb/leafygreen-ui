...
* @checksum ff2e596f47dbad2c44ae2ced594592a3
*/
...
const Disconnect = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Disconnect');

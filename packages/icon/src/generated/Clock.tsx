...
* @checksum df88991cc2daaf33a4ee43d68eda67b7
*/
...
const Clock = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Clock');

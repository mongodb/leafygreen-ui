...
* @checksum 0e497bb7d524f83b9c965f12b9037c00
*/
...
const InternalEmployee = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('InternalEmployee');

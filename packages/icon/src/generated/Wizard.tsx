...
* @checksum ae227810f513e92f59e1334adb93db64
*/
...
const Wizard = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Wizard');

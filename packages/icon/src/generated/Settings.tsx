...
* @checksum e351363975cde13d017d7758a3682311
*/
...
const Settings = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Settings');

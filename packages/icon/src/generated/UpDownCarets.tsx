...
* @checksum d2066b1a7d7137e367878b56c2e19e51
*/
...
const UpDownCarets = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('UpDownCarets');

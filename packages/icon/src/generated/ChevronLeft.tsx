...
* @checksum 652996f1b040324ea9ec2796c48dc0ad
*/
...
const ChevronLeft = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('ChevronLeft');

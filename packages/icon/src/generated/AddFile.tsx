...
* @checksum 7dc242cf43bd7987a23f69ae65693f77
*/
...
const AddFile = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('AddFile');

...
* @checksum e8508e6958fab9bf27abe7d0560e51a0
*/
...
const GovernmentBuilding = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('GovernmentBuilding');

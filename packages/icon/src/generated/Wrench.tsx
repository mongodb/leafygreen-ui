...
* @checksum 6059fe44d424af8a8100722d38e394dd
*/
...
const Wrench = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Wrench');

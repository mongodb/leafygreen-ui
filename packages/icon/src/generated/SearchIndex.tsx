...
* @checksum ffab8fb9e2086344aa2e4f42eaee5196
*/
...
const SearchIndex = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('SearchIndex');

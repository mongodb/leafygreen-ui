...
* @checksum ca033ba9f57d5d88a9d1b687eb3b0b7a
*/
...
const File = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('File');

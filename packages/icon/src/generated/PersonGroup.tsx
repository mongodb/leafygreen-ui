...
* @checksum 9b9a1926407f7f8d9cf5667ac8cc8300
*/
...
const PersonGroup = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('PersonGroup');

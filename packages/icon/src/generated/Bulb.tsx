...
* @checksum e451390d0aae4c79eb241b84d2723aae
*/
...
const Bulb = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Bulb');

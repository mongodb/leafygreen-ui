...
* @checksum 1be302f42fdfa401b96c4fbc2cb72f74
*/
...
const NavCollapse = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('NavCollapse');

...
* @checksum c1b3c306476d5155d1593646d3602db4
*/
...
const Copy = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Copy');

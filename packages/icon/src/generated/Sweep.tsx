...
* @checksum 5b9b251988965206c01984ca1d87876c
*/
...
const Sweep = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Sweep');

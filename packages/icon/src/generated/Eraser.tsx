...
* @checksum 670ba18f67e4a783711f6617d8210074
*/
...
const Eraser = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Eraser');

...
* @checksum 4a4ffbf5618fa6960e489d193972bd3c
*/
...
const X = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('X');

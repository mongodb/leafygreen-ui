...
* @checksum 2086f978ebe5053b58584ff88e8962db
*/
...
const Connect = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Connect');

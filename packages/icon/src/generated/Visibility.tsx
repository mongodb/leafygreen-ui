...
* @checksum dd2fe6178164c9f251251c6169b4f173
*/
...
const Visibility = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Visibility');

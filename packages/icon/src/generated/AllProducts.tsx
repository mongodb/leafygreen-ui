...
* @checksum d2c5a635536fe64cc274e5d465baa9b0
*/
...
const AllProducts = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('AllProducts');

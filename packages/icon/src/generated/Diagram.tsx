...
* @checksum 819bb47edc90263dc95be92036682608
*/
...
const Diagram = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Diagram');

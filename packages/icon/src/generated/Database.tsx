...
* @checksum e3562cb34fa3719023fd2ac955268b16
*/
...
const Database = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Database');

...
* @checksum 16ec74d945c58c8e3a624ef7a857b1ef
*/
...
const ArrowRight = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('ArrowRight');

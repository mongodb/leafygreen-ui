...
* @checksum 104e4ae7037c4b1fc92c4f5746a1058d
*/
...
const Bell = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Bell');

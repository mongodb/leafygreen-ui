...
* @checksum ef41d76b657d9f609805b3b58156db7e
*/
...
const CheckmarkWithCircle = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('CheckmarkWithCircle');

...
* @checksum ca4e0f0b5090cfaca9ceccd75345cfae
*/
...
const LightningBolt = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('LightningBolt');

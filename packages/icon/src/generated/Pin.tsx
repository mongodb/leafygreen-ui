...
* @checksum a2d53a201d78546c43656e6076b31828
*/
...
const Pin = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Pin');

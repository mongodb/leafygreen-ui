...
* @checksum b452651418e34b191d4fe727ae7fef5d
*/
...
const ChevronRight = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('ChevronRight');

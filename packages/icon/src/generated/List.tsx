...
* @checksum ecf4e0dabb05a561bee2ec355ca7de6a
*/
...
const List = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('List');

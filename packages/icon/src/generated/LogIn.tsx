...
* @checksum 671bb47ef713ee06596ab148304cc98b
*/
...
const LogIn = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('LogIn');

...
* @checksum aad7286754d8cc74725c21c20f9b5962
*/
...
const Return = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Return');

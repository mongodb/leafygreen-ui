...
* @checksum 2158ecb7bdbaf5f91796e0ce74f0d338
*/
...
const Link = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Link');

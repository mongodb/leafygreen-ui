...
* @checksum bda099280d84e870f8085a0c1078aec7
*/
...
const CurlyBraces = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('CurlyBraces');

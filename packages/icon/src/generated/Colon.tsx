...
* @checksum ceb2cdc34d8dc8769ac757bc085aead8
*/
...
const Colon = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Colon');

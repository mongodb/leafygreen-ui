...
* @checksum 91bc68f11122cd8bf4cf5bbc61f069ba
*/
...
const QuestionMarkWithCircle = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('QuestionMarkWithCircle');

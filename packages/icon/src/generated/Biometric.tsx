...
* @checksum 62ecc876f87577fbc2d1d74499ce3475
*/
...
const Biometric = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Biometric');

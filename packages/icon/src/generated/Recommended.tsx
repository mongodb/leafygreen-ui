...
* @checksum 0c8667d190456775de965d52ac5a5a34
*/
...
const Recommended = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Recommended');

...
* @checksum 2935d98c8629992fddac883bb22c13cc
*/
...
const Cloud = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Cloud');

...
* @checksum 93e4a7b3464623e6378439bd111e806b
*/
...
const MultiDirectionArrow = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('MultiDirectionArrow');

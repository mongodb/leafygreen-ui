...
* @checksum a12d3d7e0def3bcd0fbaf5369aa0597a
*/
...
const Stitch = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Stitch');

...
* @checksum 2a2b73076828df58a5f711e374eaa3b3
*/
...
const Config = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Config');

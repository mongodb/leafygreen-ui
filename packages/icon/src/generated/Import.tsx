...
* @checksum a69b972c0c2fd07ebcfad99b062f2e2c
*/
...
const Import = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Import');

...
* @checksum 2add32af6aee6ff0d27f354e04783a59
*/
...
const OpenNewTab = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('OpenNewTab');

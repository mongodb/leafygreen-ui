...
* @checksum 70f3585a891f5064cbf8739741b30b78
*/
...
const ArrowUp = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('ArrowUp');

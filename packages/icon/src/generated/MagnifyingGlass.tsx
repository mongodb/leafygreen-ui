...
* @checksum 0dfca441eafb3a5dfbf4901ffb1a7743
*/
...
const MagnifyingGlass = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('MagnifyingGlass');

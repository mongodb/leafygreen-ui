...
* @checksum b5040eaa967923337031f9ba6ed4cc64
*/
...
const Shell = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Shell');

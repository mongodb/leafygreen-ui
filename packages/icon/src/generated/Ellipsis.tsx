...
* @checksum 68560660381f341ab36cb043d823fffe
*/
...
const Ellipsis = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Ellipsis');

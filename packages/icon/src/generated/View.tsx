...
* @checksum 33e5cb85d098949b4f3ae265492e99df
*/
...
const View = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('View');

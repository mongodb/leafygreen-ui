...
* @checksum edb87816152d26519e81be8a09ad1938
*/
...
const Filter = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Filter');

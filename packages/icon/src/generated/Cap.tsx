...
* @checksum 7fd64740f12fdd5f31a6cf68eb2008cf
*/
...
const Cap = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Cap');

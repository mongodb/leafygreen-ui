...
* @checksum d3551759e88a6a68969d1dc63b58f640
*/
...
const TemporaryTable = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('TemporaryTable');

...
* @checksum 001db497cb851718927048bc4b6d343d
*/
...
const Key = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Key');

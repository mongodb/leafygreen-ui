...
* @checksum d53d48f018ffdebe1b7d9f37f3d6aca9
*/
...
const Moon = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Moon');

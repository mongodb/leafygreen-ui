...
* @checksum 5ba6509d4a760bfba6aa4dd9b93fe203
*/
...
const Gauge = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Gauge');

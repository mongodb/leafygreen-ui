...
* @checksum ec0fc08690bce43484e309593c50f932
*/
...
const Shield = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Shield');

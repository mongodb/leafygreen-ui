...
* @checksum 4ed7a9499fbed6b3a2eb450268f4b61b
*/
...
const VerticalEllipsis = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('VerticalEllipsis');

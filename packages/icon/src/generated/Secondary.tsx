...
* @checksum c413eb0942b6bdf9aa6a22248c53ea74
*/
...
const Secondary = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Secondary');

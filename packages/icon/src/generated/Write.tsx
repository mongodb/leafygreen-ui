...
* @checksum 71347ea300c36a512b3d28d05de242db
*/
...
const Write = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Write');

...
* @checksum 5bc868a4648f8b58fcc25feaf3510330
*/
...
const FullScreenExit = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('FullScreenExit');

...
* @checksum 7cb6d35ab6d97e455b879b467bf94d83
*/
...
const Resource = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Resource');

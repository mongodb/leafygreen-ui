...
* @checksum 7e5c819d82d0a8dcacc569e86d0771d8
*/
...
const SortDescending = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('SortDescending');

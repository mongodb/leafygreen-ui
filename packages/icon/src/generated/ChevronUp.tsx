...
* @checksum b8ca602b045aad7fab6571b1f7f25bd2
*/
...
const ChevronUp = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('ChevronUp');

...
* @checksum d46e374babdd4baa587642048f25b4bf
*/
...
const ChartFilled = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('ChartFilled');

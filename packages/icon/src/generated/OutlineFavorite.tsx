...
* @checksum 340b95dc97f7ac54ed48bcae9066f3d1
*/
...
const OutlineFavorite = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('OutlineFavorite');

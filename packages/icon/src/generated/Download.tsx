...
* @checksum de51043cc324881f67df8c66f14b87ff
*/
...
const Download = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Download');

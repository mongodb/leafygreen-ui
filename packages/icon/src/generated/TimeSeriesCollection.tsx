...
* @checksum 7f1b6e29973d02016b62ea6490f00b29
*/
...
const TimeSeriesCollection = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('TimeSeriesCollection');

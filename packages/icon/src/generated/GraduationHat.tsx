...
* @checksum f86c3df58bc8f2bc993c22e102b6fd72
*/
...
export interface GraduationHatProps extends LGGlyph.ComponentProps {}
const GraduationHat = ({
  className,
  size = 16,
  title,
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const accessibleProps = generateAccessibleProps(role, 'GraduationHat', {
    title,
    ['aria-label']: ariaLabel,
    ['aria-labelledby']: ariaLabelledby
  });
...
GraduationHat.isGlyph = true;
GraduationHat.propTypes = {

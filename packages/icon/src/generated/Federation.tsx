...
* @checksum c97dbc3bcd46cd5a86dcfb514fa5b85c
*/
...
const Federation = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Federation');

...
* @checksum ad7a98193391547c546b01c95910ad8c
*/
...
const Save = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('Save');

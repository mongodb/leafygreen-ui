...
* @checksum 5f576e444f35858dcfe7c832368374eb
*/
...
const VisibilityOff = ({
  ...
  const noFlexShrink = css`
        flex-shrink: 0;
      `;
  const safeTitle = title || getGlyphLabel('VisibilityOff');

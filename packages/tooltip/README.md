...
| `variant`         | `'default'` \| `'compact'`                | Variant of the tooltip to be rendered. When `variant` is `'compact'`, the `baseFontSize` prop is not allowed.                                                                                                                                                                                                                                                                                                                                                                                                                                  | `'default'`                                 |
...
| `baseFontSize`    | `13` \| `16`                              | Allows consuming applications to override font-size as set by the LeafyGreen Provider. **Note:** This prop is only allowed when `variant` is `'default'` (or undefined). It is not available when `variant` is `'compact'`.                                                                                                                                                                                                                                                                                                                    | default to value set by LeafyGreen Provider |

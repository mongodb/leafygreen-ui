...
| `glyph`        | `string`                                       | Can be supplied instead of a trigger, to render the Tooltip's trigger as an IconButton with the supplied glyph. Trigger will still defer to the designated trigger prop, so supplying a value here will have no effect if trigger prop value is provided.                                                                                                                                                                                                                                                                                      |                        |

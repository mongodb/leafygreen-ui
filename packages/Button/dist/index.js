(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["leafygreen"] = factory(require("react"), require("prop-types"));
	else
		root["leafygreen"] = factory(root["react"], root["prop-types"]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_create_emotion__ = __webpack_require__(8);
...
var _polished = __webpack_require__(12);
...
var buttonThemes = {
  default: {
    color: _theme.colors.gray[1],
    backgroundColor: _theme.colors.mongodb.white,
    backgroundImage: 'linear-gradient(' + _theme.colors.mongodb.white + ', ' + (0, _polished.lighten)(0.2, _theme.colors.gray[5]) + ')',
    borderColor: _theme.colors.gray[6],
    boxShadow: 'inset 0 -1px 0 ' + _theme.colors.gray[6],

    hover: {
      color: _theme.colors.gray[0],
      borderColor: _theme.colors.gray[5],
      backgroundColor: _theme.colors.mongodb.white,
      backgroundImage: 'linear-gradient(' + (0, _polished.lighten)(0.5, _theme.colors.gray[5]) + ', ' + (0, _polished.lighten)(0.15, _theme.colors.gray[5]) + ')',
      boxShadow: 'inset 0 -1px 0 ' + _theme.colors.gray[5] + ', 0 1px 4px rgba(0, 0, 0, 0.1)'
    },

    active: {
      borderColor: _theme.colors.gray[5],
      backgroundImage: 'linear-gradient(' + (0, _polished.lighten)(0.15, _theme.colors.gray[5]) + ', ' + (0, _polished.lighten)(0.5, _theme.colors.gray[5]) + ')',
      boxShadow: 'inset 0 2px 2px rgba(0, 0, 0, 0.1)'
    }
  },

  primary: {
    color: _theme.colors.mongodb.white,
    backgroundColor: _theme.colors.green[2],
    backgroundImage: 'linear-gradient(' + _theme.colors.green[2] + ', ' + (0, _polished.lighten)(0.025, _theme.colors.green[1]) + ')',
    borderColor: (0, _polished.darken)(0.02, _theme.colors.green[2]),
    boxShadow: 'inset 0 -1px 0 rgba(0, 0, 0, 0.15)',

    hover: {
      borderColor: (0, _polished.darken)(0.07, _theme.colors.green[1]),
      backgroundColor: (0, _polished.darken)(0.05, _theme.colors.green[2]),
      backgroundImage: 'linear-gradient(' + (0, _polished.darken)(0.025, _theme.colors.green[2]) + ', ' + (0, _polished.darken)(0.025, _theme.colors.green[1]) + ')',
    ...
    active: {
      color: _theme.colors.mongodb.white,
      backgroundColor: _theme.colors.green[2],
      backgroundImage: 'linear-gradient(' + (0, _polished.darken)(0.025, _theme.colors.green[1]) + ', ' + (0, _polished.darken)(0.025, _theme.colors.green[2]) + ')',
      borderColor: (0, _polished.darken)(0.07, _theme.colors.green[1]),
  ...
  info: {
    color: _theme.colors.green[2],
    backgroundColor: 'transparent',
    borderColor: _theme.colors.green[2],
    boxShadow: 'none',
    ...
    hover: {
      ...
      backgroundColor: (0, _polished.darken)(0.05, _theme.colors.green[2]),
      backgroundImage: 'linear-gradient(' + _theme.colors.green[2] + ', ' + (0, _polished.lighten)(0.025, _theme.colors.green[1]) + ')',
      borderColor: (0, _polished.darken)(0.02, _theme.colors.green[1]),
  ...
  danger: {
    ...
    backgroundImage: 'linear-gradient(' + (0, _polished.darken)(0.1, _theme.colors.mongodb.alertRed) + ', ' + (0, _polished.darken)(0.2, _theme.colors.mongodb.alertRed) + ')',
    borderColor: '#97130C',
    boxShadow: 'inset 0 -1px 0 0 ' + (0, _polished.darken)(0.25, _theme.colors.mongodb.alertRed),

    hover: {
      backgroundColor: (0, _polished.darken)(0.05, '#BD180F'),
      backgroundImage: 'linear-gradient(' + (0, _polished.darken)(0.15, _theme.colors.mongodb.alertRed) + ', ' + (0, _polished.darken)(0.25, _theme.colors.mongodb.alertRed) + ')',
      borderColor: (0, _polished.darken)(0.1, '#BD180F'),
      boxShadow: '0 1px 4px rgba(0, 0, 0, 0.1), inset 0 -1px 0 ' + (0, _polished.darken)(0.25, _theme.colors.mongodb.alertRed)
    },

    active: {
      backgroundImage: 'linear-gradient(' + (0, _polished.darken)(0.2, _theme.colors.mongodb.alertRed) + ', ' + (0, _polished.darken)(0.1, _theme.colors.mongodb.alertRed) + ')',
      boxShadow: 'inset 0 2px 2px rgba(0, 0, 0, 0.1)'
    }
  },
  ...
  dark: {
    ...
    backgroundImage: 'linear-gradient(' + _theme.colors.gray[3] + ', ' + _theme.colors.gray[1] + ')',
    boxShadow: 'inset 0 -1px 0 ' + _theme.colors.gray[0],
    ...
    active: {
      backgroundImage: 'linear-gradient(' + _theme.colors.gray[1] + ', ' + _theme.colors.gray[3] + ')',
      borderColor: _theme.colors.gray[0]
    }
  }
};
...
var buttonSizes = {
  xsmall: _extends({}, defaultButtonSize, {
    height: '22px',
    padding: '0 8px',
    fontSize: '11px',
    lineHeight: '21px',
  ...
  small: _extends({}, defaultButtonSize, {
    height: '25px',
    padding: '0 10px',
    lineHeight: '23px'
  }),
  ...
  large: _extends({}, defaultButtonSize, {
    height: '45px',
    lineHeight: '44px',
    fontSize: '16px',
    padding: '0 20px'
...
var buttonStyles = function buttonStyles(theme, size) {
  return (/*#__PURE__*/(0, _reactEmotion.css)('color:', theme.color, ';background-color:', theme.backgroundColor, ';background-image:', theme.backgroundImage, ';border:1px solid ', theme.borderColor, '};box-shadow:', theme.boxShadow, ';height:', size.height, ';padding:', size.padding, ';font-size:', size.fontSize, ';font-weight:', size.fontWeight, ';line-height:', size.lineHeight, ';text-transform:', size.textTransform, ';box-sizing:border-box;border-radius:3px;display:inline-block;transition:all 120ms ease;text-decoration:none;cursor:pointer;&[disabled]{color:', _theme.colors.gray[3], ';border-color:', _theme.colors.gray[5], ';background-color:', _theme.colors.gray[7], ';background-image:none;box-shadow:none;cursor:not-allowed;}&:focus,&:hover{&:not([disabled]){color:', theme.hover && theme.hover.color, ';border-color:', theme.hover && theme.hover.borderColor, ';background-color:', theme.hover && theme.hover.backgroundColor, ';background-image:', theme.hover && theme.hover.backgroundImage, ';box-shadow:', theme.hover && theme.hover.boxShadow, ';outline:none;}}&:active:not([disabled]){color:', theme.active && theme.active.color, ';borderColor:', theme.active && theme.active.borderColor, ';background-color:', theme.active && theme.active.backgroundColor, ';background-image:', theme.active && theme.active.backgroundImage, ';box-shadow:', theme.active && theme.active.boxShadow, ';outline:none;}')
  );
};
...
var Button = function (_Component) {
  ...
  _createClass(Button, [{
    ...
    value: function render() {
      ...
      var variantStyle = buttonThemes[variant] || buttonThemes.default;
      var sizeStyle = buttonSizes[size] || buttonSizes.normal;

      return _react2.default.createElement(
        'button',
        {
          className: (0, _lib.ccClassname)(buttonStyles(variantStyle, sizeStyle), className),
          style: style,
          name: name,
          title: title,
          onClick: onClick,
...
// EXTERNAL MODULE: /Users/davemccarthy/Repositories/MongoDB/leafygreen-ui/node_modules/emotion/dist/index.esm.js
...
// EXTERNAL MODULE: /Users/davemccarthy/Repositories/MongoDB/leafygreen-ui/node_modules/@emotion/memoize/dist/memoize.esm.js
var memoize_esm = __webpack_require__(3);

// CONCATENATED MODULE: /Users/davemccarthy/Repositories/MongoDB/leafygreen-ui/node_modules/@emotion/is-prop-valid/dist/is-prop-valid.esm.js
...
// CONCATENATED MODULE: /Users/davemccarthy/Repositories/MongoDB/leafygreen-ui/node_modules/create-emotion-styled/dist/index.esm.js
...
var _contextTypes;
var contextTypes = (_contextTypes = {}, _contextTypes[channel] = external__prop_types__default.a.object, _contextTypes);
...
// CONCATENATED MODULE: /Users/davemccarthy/Repositories/MongoDB/leafygreen-ui/node_modules/react-emotion/dist/index.esm.js
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "flush", function() { return index_esm["flush"]; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "hydrate", function() { return index_esm["hydrate"]; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "cx", function() { return index_esm["cx"]; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "merge", function() { return index_esm["merge"]; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "getRegisteredStyles", function() { return index_esm["getRegisteredStyles"]; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "injectGlobal", function() { return index_esm["injectGlobal"]; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "keyframes", function() { return index_esm["keyframes"]; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "css", function() { return index_esm["css"]; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "sheet", function() { return index_esm["sheet"]; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "caches", function() { return index_esm["caches"]; });





var index_esm_index = dist_index_esm(index_esm, external__react__default.a);

/* harmony default export */ var react_emotion_dist_index_esm = __webpack_exports__["default"] = (index_esm_index);
...
// CONCATENATED MODULE: /Users/davemccarthy/Repositories/MongoDB/leafygreen-ui/node_modules/@emotion/unitless/dist/unitless.esm.js
var unitlessKeys = {
...
// CONCATENATED MODULE: /Users/davemccarthy/Repositories/MongoDB/leafygreen-ui/node_modules/@emotion/hash/dist/hash.esm.js
/* eslint-disable */
...
// CONCATENATED MODULE: /Users/davemccarthy/Repositories/MongoDB/leafygreen-ui/node_modules/@emotion/stylis/dist/stylis.esm.js
...
// EXTERNAL MODULE: /Users/davemccarthy/Repositories/MongoDB/leafygreen-ui/node_modules/stylis-rule-sheet/index.js
var stylis_rule_sheet = __webpack_require__(9);
var stylis_rule_sheet_default = /*#__PURE__*/__webpack_require__.n(stylis_rule_sheet);

// CONCATENATED MODULE: /Users/davemccarthy/Repositories/MongoDB/leafygreen-ui/node_modules/create-emotion/dist/index.esm.js
...
(function webpackUniversalModuleDefinition(root, factory) {
  if (( false ? 'undefined' : _typeof(exports)) === 'object' && ( false ? 'undefined' : _typeof(module)) === 'object') module.exports = factory();else if (true) !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				...
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));else if ((typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object') exports["leafygreen"] = factory();else root["leafygreen"] = factory();
...
// CONCATENATED MODULE: /Users/davemccarthy/Repositories/MongoDB/leafygreen-ui/node_modules/@babel/runtime/helpers/esm/extends.js
function _extends() {
...
// CONCATENATED MODULE: /Users/davemccarthy/Repositories/MongoDB/leafygreen-ui/node_modules/@babel/runtime/helpers/esm/taggedTemplateLiteralLoose.js
...
// CONCATENATED MODULE: /Users/davemccarthy/Repositories/MongoDB/leafygreen-ui/node_modules/polished/dist/polished.es.js

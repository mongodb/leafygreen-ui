...
type SvgBlobProperties = 'viewBox' | 'path' | 'styles';
...
function svgBlobs(blobPosition: BlobPosition, darkMode: boolean) {
  const { viewBox, path, styles } = svgBlobPaths[blobPosition];

...
| `glyphVisibility` | `'visible'` \| `'nav-collapsed'` \| `'nav-expanded'` | Value which indicates when the glyph should be visible. The glyph will never be visible when the nav is collapsed when the item is disabled.          | `'nav-collapsed'`               |

...
import { ControlledInputValueReturnObject } from './useControlledInputValue.types';

/**
 * A hook that enables an input component to be both controlled or uncontrolled.
 *
 * Returns a {@link ControlledInputValueReturnObject} with the controlled or uncontrolled `value`,
...
export const useControlledInputValue = <T>(
  ...
  initialValue?: T,
): ControlledInputValueReturnObject<T | undefined> => {

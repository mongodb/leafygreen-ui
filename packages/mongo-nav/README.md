...
| `constructOrganizationURL` | `(Organization) => string`                                                      | Function to determine destination URL when user selects an organization from the organization picker, see also `hosts`                                                                                                                                                                                                                   | `(Organization) => '${hosts.cloud}/v2#/org/${Organization.orgId}/projects'` |

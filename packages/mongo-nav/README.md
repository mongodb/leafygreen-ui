...
| `activeOrgId`              | `string`                                                                       | ID for active organization, will cause a POST request to the database to update current active organization.                                              |                                                         |
| `activeProjectId`          | `string`                                                                       | ID for active project, will cause a POST request to the database to update current active project.                                                        |

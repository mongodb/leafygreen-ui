...
export function CloudIcon(props: HTMLElementProps<'svg'>) {
  return (
    <svg {...props} width="24px" height="19px" viewBox="0 0 24 19">
      <g
        stroke="none"
        strokeWidth="1"
        fill="none"
...
export function UniversityIcon(props: HTMLElementProps<'svg'>) {
  return (
    <svg {...props} width="24px" height="25px" viewBox="0 0 24 25">
      <g
        stroke="none"
        strokeWidth="1"
        fill="none"
...
export function MegaphoneIcon(props: HTMLElementProps<'svg'>) {
  return (
    <svg {...props} width="24px" height="18px" viewBox="0 0 24 18">
      <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        <g stroke="currentColor">
          <g>

...
export function CloudIcon(props: HTMLElementProps<'svg'>) {
  return (
    <svg {...props} width="32px" height="19px" viewBox="0 0 32 19">
      <g
        stroke="none"
        strokeWidth="1"
        fill="none"
...
export function SupportIcon(props: HTMLElementProps<'svg'>) {
  return (
    <svg {...props} width="32px" height="24px" viewBox="0 0 32px 24">
      <g
        stroke="none"
        strokeWidth="1"
        fill="none"
...
export function UniversityIcon(props: HTMLElementProps<'svg'>) {
  return (
    <svg {...props} width="32px" height="25px" viewBox="0 0 32 25">
      <g
        stroke="none"
        strokeWidth="1"
        fill="none"
...
export function MegaphoneIcon(props: HTMLElementProps<'svg'>) {
  return (
    <svg {...props} width="32px" height="18px" viewBox="0 0 32 18">
      <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        <g stroke="currentColor">
          <g>

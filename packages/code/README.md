...
| `copyButtonAppearance`    | `CopyButtonAppearance`               | When true, allows the code block to be copied to the user's clipboard. TODO: This will be updated in the copy button appearance pr                                                   | `true`  |

...
- Updated dependencies [d7bcde1]
  - @leafygreen-ui/toolbar@1.3.0
...
- c0ce1c4: Fixes bug where the drawer would not close when the active item was removed from the data passed to the `toolbarData` prop.

...
| `roleType?`        | `'progressbar'` \| `'meter'`                                                                   | `'progressbar'` | determinate only                         | Specify role of the progress bar ("progressbar" or "meter"). Defaults to "progressbar".                                               |
| `value`            | `number`                                                                                       |                 | all                                      | Current progress value. **Optional only if isIndeterminate is `true`.**                                                               |
| `maxValue?`        | `number`                                                                                       |                 | determinate only                         | Maximum progress value.                                                                                                               |

...
const imagePath = `${CDN}/images/new-guidelines/accessibility`;
...
<GuidelineImage imageURL={`${imagePath}/A11y-guidelines-asset-1@3x.gif`} />
...
<GuidelineImage imageURL={`${imagePath}/A11y-guidelines-asset-2@3x.png`} />

The 4.5:1 contrast standard also applies to text within components.

<GuidelineImage imageURL={`${imagePath}/A11y-guidelines-asset-3@3x.png`} />
...
<GuidelineImage imageURL={`${imagePath}/A11y-guidelines-asset-4@3x.png`} />
...
<GuidelineImage imageURL={`${imagePath}/A11y-guidelines-asset-5@3x.png`} />
...
<GuidelineImage imageURL={`${imagePath}/A11y-guidelines-asset-6@3x.png`} />
...
<GuidelineImage imageURL={`${imagePath}/A11y-guidelines-asset-7@3x.png`} />
...
<GuidelineImage imageURL={`${imagePath}/A11y-guidelines-asset-8@3x.png`} />
...
<GuidelineImage imageURL={`${imagePath}/A11y-guidelines-asset-9@3x.png`} />
...
<GuidelineImage imageURL={`${imagePath}/A11y-guidelines-asset-10@3x.png`} />
...
<GuidelineImage imageURL={`${imagePath}/A11y-guidelines-asset-11@3x.png`} />

...
<img
  src={`${process.env.NEXT_PUBLIC_CDN}/images/guidelines/callout-header-guidelines.png`}
...
<img
  src={`${process.env.NEXT_PUBLIC_CDN}/images/guidelines/callout-table-example-guidelines.png`}
...
<img
  src={`${process.env.NEXT_PUBLIC_CDN}/images/guidelines/callout-code-example-guidelines.png`}
...
<img
  src={`${process.env.NEXT_PUBLIC_CDN}/images/guidelines/callout-example-example-guidelines.png`}

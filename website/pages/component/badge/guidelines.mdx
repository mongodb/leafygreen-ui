...
<GuidelineImage
  imageURL={`${CDN}/images/guidelines/badge/badge-guidelines-1.png`}
  className={css`
    width: auto;
    height: 178px;
  `}
...
<GuidelineImage
  imageURL={`${CDN}/images/guidelines/badge/badge-guidelines-2.png`}
  className={css`
    width: auto;
    height: 178px;
  `}
...
<GuidelineImage
  imageURL={`${CDN}/images/guidelines/badge/badge-guidelines-3.png`}
  className={css`
    width: auto;
    height: 178px;
  `}
...
<GuidelineImage
  imageURL={`${CDN}/images/guidelines/badge/badge-guidelines-4.png`}
  className={css`
    width: auto;
    height: 178px;
  `}
...
<GuidelineImage
  imageURL={`${CDN}/images/guidelines/badge/badge-guidelines-5.png`}
  className={css`
    width: auto;
    height: 178px;
  `}
...
- **Green**: Use to communicate the status of content. (Approved, successful, positive)
    - *Exception*: A green badge can be used other than displaying status when there needs to be a differentiation from the other color badges. 

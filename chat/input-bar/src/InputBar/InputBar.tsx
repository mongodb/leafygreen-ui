...
import { AdditionalActions } from '../components';
...
import { InputBarSubcomponentProperty, State } from '../shared.types';
...
export const InputBar = CompoundComponent(
  // eslint-disable-next-line react/display-name
  forwardRef<HTMLFormElement, InputBarProps>(
    (
      {
        children,
        className,
      ...
      const inputId = useIdAllocator({
        prefix: 'lg-chat-input-bar',
        id: idProp,
      });
      ...
      const additionalActions = findChild(
        children,
        InputBarSubcomponentProperty.AdditionalActions,
      );
      const remainingChildren = filterChildren(
        children,
        Object.values(InputBarSubcomponentProperty),
      );
      ...
      const processChildren = useCallback(() => {
        ...
        const flattenedChildren = flattenChildren(remainingChildren);
      ...
      }, [remainingChildren, promptRefs, highlightIndex, updateValue, formRef]);

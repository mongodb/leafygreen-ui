...
- 3dfa899: - Removed `variant` prop and `Variant` enum export. The provider no longer supports variant selection (spacious/compact). All components now use a single, consistent design.

module.exports = {
  parser: 'babel-eslint',
  plugins: ['@emotion'],
  extends: ['eslint:recommended', 'plugin:react/recommended', 'plugin:react-hooks/recommended', 'plugin:jest/recommended', 'prettier', 'prettier/react', 'plugin:jsx-a11y/recommended', 'plugin:storybook/recommended'],
  parserOptions: {
    sourceType: 'module',
    ecmaFeatures: {
      jsx: true
